...
import {ColumnRequest, ConstraintRequest, DeleteRequest, DropTriggerRequest, EditCollectionRequest, EditTableRequest, ExploreTable, MaterializedRequest, MonitoringRequest, QueryRequest, RelAlgRequest, Schema, SchemaRequest, StatisticRequest, TableRequest, TriggerRequest} from '../models/ui-request.model';
...
export class CrudService {
  ...
  dropTrigger(request: DropTriggerRequest) {
    return this._http.post(`${this.httpUrl}/dropTrigger`, request, this.httpOptions);
  }
